...
def int_env(env_var: str, default: int) -> int:
    """
    Cast environment variable to int
    :return:
    """
    return int(env(env_var, default))
...
# The number of worker processes that this serve
workers = int_env("GUNICORN_WORKERS", (2 * cpu_count()) + 1)
...
timeout = int_env("GUNICORN_TIMEOUT", 30)
